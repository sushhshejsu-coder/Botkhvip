...
# ទាញយក Key ពី Environment Variables លើ Railway (ឬដាក់ផ្ទាល់បើធ្វើតេស្ត)
TELEGRAM_BOT_TOKEN = os.environ.get("TELEGRAM_BOT_TOKEN", "8629057978:AAFgSqpLGa7Oi5bnCoNw36BF7b6q6PsA8IY")
GEMINI_API_KEY = os.environ.get("GEMINI_API_KEY", "AQ.Ab8RN6LQ4MnYXqzEDl57BbPzqxzEWNY-Is1zSpS2jqurh-oZzg")

# កំណត់រចនាសម្ព័ន្ធ Google Gemini API
genai.configure(api_key=GEMINI_API_KEY)

# ប្រើប្រាស់ Model ស្តង់ដារ Gemini 1.5 Flash
...
def send_telegram_message(chat_id, text):
    ...
    try:
        ...
        if response.status_code != 200:
            # ប្រសិនបើមានបញ្ហាជាមួយ Markdown ត្រូវផ្ញើសារជា Plain Text ជំនួសវិញ
